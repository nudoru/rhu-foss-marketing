    ...
    <section class="container fade-in-section">
      ...
      <div class="flex-group-row-c">
        <a href="https://www.synegen.com/open-learning-platform#start"  target="_blank">
          <button class="success large" style="margin-right: 2rem;" >Get started</button>
        </a>
        <a href="https://openlearningplatform.org/demo" target="_blank">
          <button class="large secondary"  style="margin-right: 2rem;">Demo</button>
        </a>
        <a href="https://github.com/openlearningplatformlxp/lxp" target="_blank">
          <button class="large primary"><i class="fab fa-github" style="margin-right: .25rem;"></i>GitHub</button>
        </a>
      </div>
    </section>
    <section class="container fade-in-section">
